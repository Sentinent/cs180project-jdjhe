...
(function () {
  ...
  function db(g, l) {
    ...
    for (0 > s && (s += v); s < v; s++)
      if (s in this && this[s] === g) return s;
    return -1;
  }
  function s(g) {
  ...
  function gb(g) {
    if (g._menuButton)
      g.exportEnabled
        ? (ga(g._menuButton, {
          ...
          Ka(g._menuButton),
          (g._menuButton.title = g._cultureInfo.menuText))
        : ua(g._menuButton);
        ...
        function () {
          'none' !== g._dropdownMenu.style.display ||
            (g._dropDownCloseTime &&
              500 >= new Date().getTime() - g._dropDownCloseTime.getTime()) ||
            ((g._dropdownMenu.style.display = 'block'),
            g._menuButton.blur(),
            g._dropdownMenu.focus());
        },
        g.allDOMEventHandlers,
        !0
      );
    ...
    if (g.exportEnabled && g._dropdownMenu) {
      ...
      for (
        var v = g._dropdownMenu.childNodes,
          s = [
            g._cultureInfo.printText,
            g._cultureInfo.saveJPGText,
            g._cultureInfo.savePNGText,
          ],
          qa = 0;
        qa < v.length;
        qa++
      ...
      !g._dropdownMenu &&
          ...
          function () {
            l ||
              ((this.style.backgroundColor =
                g.toolbar.itemBackgroundColorOnHover),
              (this.style.color = g.toolbar.fontColorOnHover));
          },
          g.allDOMEventHandlers,
          !0
        ),
        J(
          ...
          function () {
            l ||
              ((this.style.backgroundColor = g.toolbar.itemBackgroundColor),
  ...
  function hb(g) {
    if (!ib) {
      ...
      'undefined' === typeof pa.Chart.creditHref
        ? ((g.creditHref = W('iuuqr;..b`ow`rkr/bnl.')),
          (g.creditText = W('B`ow`rKR/bnl')))
        : ((l = g.updateOption('creditText')),
          (v = g.updateOption('creditHref')));
      if (g.creditHref && g.creditText) {
        ...
        if (0 === g.renderCount || l || v)
          g._creditLink.setAttribute('href', g.creditHref),
            (g._creditLink.innerHTML = g.creditText);
        g._creditLink && g.creditHref && g.creditText
          ? (g._creditLink.parentElement ||
              g._canvasJSContainer.appendChild(g._creditLink),
            (g._creditLink.style.top = g.height - 14 + 'px'))
          : g._creditLink.parentElement &&
            g._canvasJSContainer.removeChild(g._creditLink);
      }
    }
  }
  function ta(g, l) {
  ...
  function va(g, l, v) {
    l.getAttribute('state') ||
      ((l.style.backgroundColor = g.toolbar.itemBackgroundColor),
      (l.style.color = g.toolbar.fontColor),
      (l.style.border = 'none'),
      ga(l, {
    ...
    l.getAttribute('state') !== v &&
      ...
      (l.innerHTML =
        ...
        jb[v].image +
        "' alt='" +
        g._cultureInfo[v + 'Text'] +
        "' />"));
  }
  function Ka() {
    for (var g = null, l = 0; l < arguments.length; l++)
      (g = arguments[l]), g.style && (g.style.display = 'inline');
  }
  function ua() {
    for (var g = null, l = 0; l < arguments.length; l++)
      (g = arguments[l]) && g.style && (g.style.display = 'none');
  }
  function Ra(g, l, v, s, w) {
    if (null === g || 'undefined' === typeof g)
      return 'undefined' === typeof v ? l : v;
    g =
      parseFloat(g.toString()) * (0 <= g.toString().indexOf('%') ? l / 100 : 1);
    'undefined' !== typeof s &&
      ((g = Math.min(s, g)), 'undefined' !== typeof w && (g = Math.max(w, g)));
  ...
  function U(g, l, v, w, qa) {
    ...
    this.theme && s(this.parent) && s(l) && s(w)
      ? (g = s(this.predefinedThemes[this.theme])
  ...
  (function () {
    S.fSDec = function (g) {
      for (var l = '', v = 0; v < g.length; v++)
        l += String.fromCharCode(
          Math.ceil(g.length / 57 / 5) ^ g.charCodeAt(v)
        );
      return l;
    };
    ...
    S._fTWm = function (g) {
      if ('undefined' === typeof S.pro.sCH && !bb)
        try {
          ...
          'cs' === S.pos[l] &&
            (g[S.fSDec('^bsdehuMhoj')].style.right = S.fSDec('`tun'));
        } catch (y) {}
    };
  })();
  var fb = (function () {
        ...
        if (((l = F[K]), '.' === l && 0 > N)) N = K;
          ...
          if ('%' === l) E *= 100;
            ...
            ('E' !== l[0] && 'e' !== l[0]) ||
              ...
              (S = !0);
          0 > N
            ? (M.push(l), '#' === l || '0' === l ? P++ : ',' === l && R++)
            : (H.push(l), ('#' !== l && '0' !== l) || J++);
        }
      S &&
        ((l = Math.floor(g)),
        (F = -Math.floor(Math.log(g) / Math.LN10 + 1)),
        (U = 0 === g ? 0 : 0 === l ? -(P + F) : String(l).length - P),
        (E /= Math.pow(10, U)));
      0 > N && (N = K);
      E = (g * E).toFixed(J);
      l = E.split('.');
        ...
        if (((l = M.pop()), '#' === l || '0' === l))
          if ((N++, N === P)) {
            var V = E,
              E = [];
            if ('0' === l)
              for (l = P - J - (V ? V.length : 0); 0 < l; ) V.unshift('0'), l--;
            for (; 0 < V.length; )
              (v = V.pop() + v),
                S++,
    ...
    Na = function (g) {
      ...
      g.offsetX || 0 === g.offsetX
        ? ((l = g.offsetX), (v = g.offsetY))
        : g.layerX || 0 == g.layerX
        ? ((l = g.layerX), (v = g.layerY))
        : ((l = g.pageX - g.target.offsetLeft),
          (v = g.pageY - g.target.offsetTop));
      return { x: l, y: v };
    },
    Za = !0,
    ...
    ca = function (g, l, v, s, w, y, E, F, N, M, P, S, H) {
      ...
      0 < E &&
        ...
        (g.strokeStyle = F),
        g.moveTo(l, v),
        g.rect(l - H, v - H, s - l + 2 * H, w - v + 2 * H),
        g.stroke());
      g.restore();
      !0 === N &&
        (g.save(),
    ...
    W = function (g) {
      for (var l = '', s = 0; s < g.length; s++)
        l += String.fromCharCode(
          Math.ceil(g.length / 57 / 5) ^ g.charCodeAt(s)
        );
      return l;
    },
    bb =
      ...
      (-1 !== window[W('mnb`uhno')].href.indexOf(W('b`ow`rkr/bnl')) ||
        -1 !== window[W('mnb`uhno')].href.indexOf(W('gdonqhy/bnl')) ||
  ...
  U.prototype.setOptions = function (g, l) {
    if (pa[this._defaultsKey]) {
      ...
      for (w in s)
        'publicProperties' !== w &&
          s.hasOwnProperty(w) &&
          (this[w] = g && w in g ? g[w] : l && w in l ? l[w] : s[w]);
  ...
  U.prototype.get = function (g) {
    ...
    if (
      l.hasOwnProperty(g) ||
      (l.publicProperties && l.publicProperties.hasOwnProperty(g))
    )
      return this[g];
    window.console &&
      window.console.log(
  ...
  U.prototype.updateOption = function (g) {
    ...
    this.themeOptions = w;
    g in l &&
      (y = g in this.options ? this.options[g] : w && g in w ? w[g] : l[g]);
  ...
  U.prototype.addEventListener = function (g, l, s) {
    g &&
      ...
      this._eventListeners[g].push({ context: s || this, eventHandler: l }));
  };
  ...
  U.prototype.dispatchEvent = function (g, l, s) {
    if (g && this._eventListeners[g]) {
      l = l || {};
      for (var w = this._eventListeners[g], y = 0; y < w.length; y++)
  ...
  Da.prototype.registerSpace = function (g, l) {
    'top' === g
      ...
      : 'right' === g && (this._rightOccupied += l.width);
  };
  ...
  ya.prototype.setLayout = function () {
    if (this.text) {
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? ('top' === this.verticalAlign
            ...
            : 'bottom' === this.verticalAlign &&
              ((y = l.y2 - 2 - M.height), (H = 'bottom')),
          'left' === this.horizontalAlign
            ? (w = l.x1 + 2)
            : 'center' === this.horizontalAlign
            ? (w = l.x1 + l.width / 2 - M.width / 2)
            : 'right' === this.horizontalAlign && (w = l.x2 - 2 - M.width - E),
        ...
        : 'center' === this.verticalAlign &&
          ('left' === this.horizontalAlign
            ? ((w = l.x1 + 2),
              (y = l.y2 - 2 - (this.maxWidth / 2 - M.width / 2)),
              (F = -90),
              (H = 'left'),
              (this.width = M.height),
              (this.height = M.width))
            ...
            ? ((w = l.x2 - 2),
              (y = l.y1 + 2 + (this.maxWidth / 2 - M.width / 2)),
              (F = 90),
              (H = 'right'),
              (this.width = M.height),
              (this.height = M.width))
            : 'center' === this.horizontalAlign &&
              ((y = g.y1 + (g.height / 2 - M.height / 2)),
              (w = g.x1 + (g.width / 2 - M.width / 2)),
              (H = 'center'),
              (this.width = M.width),
              (this.height = M.height)),
          (N = 'center'));
      ...
      J.horizontalAlign = N;
      this._textBlock = J;
      g.layoutManager.registerSpace(H, {
        width:
  ...
  y = Oa.Chart = (function () {
      ...
      for (var b = [], c, e = 0; e < a.length; e++)
        if (0 == e) b.push(a[0]);
          ...
          c =
            (Math.abs(
              (a[p].x - a[f].x) /
                (0 === a[p].x - a[t].x ? 0.01 : a[p].x - a[t].x)
            ) *
              (d - 1)) /
              2 +
            1;
    ...
    function y(a, d, b, c, e, f, p, t, B, k) {
      ...
      a.beginPath();
      B && 0 < t.thickness
        ? (a.moveTo(c - p.thickness / 2, Math.round((b + e) / 2) - n),
          a.lineTo(d + p.thickness / 2, Math.round((b + e) / 2) - n))
        : 0 < t.thickness &&
          (a.moveTo(Math.round((d + c) / 2) - n, b + p.thickness / 2),
          a.lineTo(Math.round((d + c) / 2) - n, e - p.thickness / 2));
      a.stroke();
    ...
    function T(a, d, b, c, e, f) {
      ...
      this.lineThickness = s(b.lineThickness)
        ? f.lineThickness
        : this.lineThickness;
            ...
            J(
              ...
              function () {
                d ||
                  ...
                  0 >= navigator.userAgent.search('MSIE') &&
                    ga(a._resetButton.childNodes[0], {
                      WebkitFilter: 'invert(100%)',
                      filter: 'invert(100%)',
                    }));
              },
        ...
        for (var b = 0; b < this.options.data.length; b++)
          if (
            ...
            !this.options.data[b].type ||
              0 <= l._supportedChartTypes.indexOf(this.options.data[b].type))
          ) {
            var c = new H(
              this,
              this.options.data[b],
            ...
            null === c.color
              ? 1 < this.options.data.length
                ? ((c._colorSet = [
                    this.selectedColorSet[
                      c.index % this.selectedColorSet.length
                    ],
                  ]),
                  (c.color =
                    this.selectedColorSet[
    ...
    l.prototype.setLayout = function () {
      ...
      if (this.options.subtitles)
        for (d = 0; d < this.options.subtitles.length; d++)
          (b = new Ha(this, this.options.subtitles[d], d)),
    ...
    l.prototype.renderElements = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          var f = this.plotInfo.plotTypes[d], p = 0;
          p < f.plotUnits.length;
          p++
        ) {
          var t = f.plotUnits[p],
            B = null;
          ...
          this.animatedRender &&
            ((t.targetCanvasCtx.miterLimit = e), B && b.push(B));
        }
    ...
    l.prototype.categoriseDataSeries = function () {
      for (var a = '', d = 0; d < this.data.length; d++)
        if (
          ...
          for (
            var b = null, c = !1, e = null, f = !1, p = 0;
            p < this.plotInfo.plotTypes.length;
            p++
          )
          ...
          for (p = 0; p < b.plotUnits.length; p++)
            if (
              b.plotUnits[p].axisYType === a.axisYType &&
              b.plotUnits[p].axisXType === a.axisXType &&
              b.plotUnits[p].axisYIndex === a.axisYIndex &&
              b.plotUnits[p].axisXIndex === a.axisXIndex
            ) {
              f = !0;
              e = b.plotUnits[p];
              break;
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          b = this.plotInfo.plotTypes[d], p = a = 0;
          p < b.plotUnits.length;
          p++
        )
          (b.plotUnits[p].previousDataSeriesCount = a),
            (a += b.plotUnits[p].dataSeriesIndexes.length);
    };
    ...
    l.prototype._processMultiseriesPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, f = !1, p = 0;
          ...
          for (B = 0; B < t.dataPoints.length; B++) {
            ...
            t.dataPoints[B].x.getTime
              ? ((f = !0), (c = t.dataPoints[B].x.getTime()))
              : (c = t.dataPoints[B].x);
            e = t.dataPoints[B].y;
            c < b.min && (b.min = c);
            c > b.max && (b.max = c);
            ...
            if (c < q && !k) null !== e && (n = c);
              ...
              t.dataPoints[B].label &&
                (a.axisX.labels[c] = t.dataPoints[B].label);
              c < b.viewPortMin && (b.viewPortMin = c);
              c > b.viewPortMax && (b.viewPortMax = c);
              null === e
                ? b.viewPortMin === c && n < c && (b.viewPortMin = n)
                : (e < d.viewPortMin &&
                    'number' === typeof e &&
                    (d.viewPortMin = e),
                  e > d.viewPortMax &&
        ...
        for (
          ...
          for (q = 0; q < n.dataPoints.length; q++) {
            ...
            n.dataPoints[q].x.getTime
              ? ((f = !0), (c = n.dataPoints[q].x.getTime()))
              : (c = n.dataPoints[q].x);
            ...
            if (c < l && !h) null !== n.dataPoints[q].y && (g = c);
              ...
              n.dataPoints[q].label &&
                (a.axisX.labels[c] = n.dataPoints[q].label);
              c < b.viewPortMin && (b.viewPortMin = c);
              c > b.viewPortMax && (b.viewPortMax = c);
              null === n.dataPoints[q].y
                ...
                : ((a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + e),
                  (a.yAbsTotals[c] =
                    (a.yAbsTotals[c] ? a.yAbsTotals[c] : 0) + Math.abs(e)),
                  0 <= e
                    ? p[c]
                      ? (p[c] += e)
                      : ((p[c] = e), (B = Math.min(e, B)))
                    : t[c]
                    ? (t[c] += e)
                    : ((t[c] = e), (k = Math.max(e, k))));
            }
          }
          a.axisY.scaleBreaks &&
        ...
        for (
          ...
          for (n = 0; n < m.dataPoints.length; n++) {
            ...
            m.dataPoints[n].x.getTime
              ? ((f = !0), (c = m.dataPoints[n].x.getTime()))
              : (c = m.dataPoints[n].x);
            ...
            if (c < g && !q) null !== e && (r = c);
              ...
              m.dataPoints[n].label &&
                (a.axisX.labels[c] = m.dataPoints[n].label);
              c < b.viewPortMin && (b.viewPortMin = c);
              c > b.viewPortMax && (b.viewPortMax = c);
              null === e
        ...
        for (
          ...
          for (m = 0; m < k.dataPoints.length; m++) {
            ...
            k.dataPoints[m].x.getTime
              ? ((t = !0), (c = k.dataPoints[m].x.getTime()))
              : (c = k.dataPoints[m].x);
            ...
            if (!(c < l) || n) {
              ...
              k.dataPoints[m].label &&
                (a.axisX.labels[c] = k.dataPoints[m].label);
              c < b.viewPortMin && (b.viewPortMin = c);
              c > b.viewPortMax && (b.viewPortMax = c);
              ...
              null === e
                ...
                : (f < d.viewPortMin && (d.viewPortMin = f),
                  p > d.viewPortMax && (d.viewPortMax = p));
            }
          }
        ...
        for (
          ...
          for (B = 0; B < t.dataPoints.length; B++)
            if (
              ...
              0 < B &&
                (a.axisX.logarithmic
                  ? ((n = c / t.dataPoints[B - 1].x),
                    1 > n && (n = 1 / n),
                    b.minDiff > n && 1 !== n && (b.minDiff = n))
                  : ((n = c - t.dataPoints[B - 1].x),
                    0 > n && (n *= -1),
                    b.minDiff > n && 0 !== n && (b.minDiff = n)),
                null !== e &&
                  null !== t.dataPoints[B - 1].y &&
                  (a.axisY.logarithmic
                    ? ((e =
    ...
    l.prototype.calculateAutoBreaks = function () {
                  ...
                  if (
                    (c &&
                      ((q =
                        ...
                        100),
                      (h = g.dataPoints[t].x.getTime
                        ? g.dataPoints[t].x.getTime()
                        : g.dataPoints[t].x),
                      (q = Math.floor((h - k) / q)),
                      h < f[q].min && (f[q].min = h),
                      h > f[q].max && (f[q].max = h)),
                    ...
                    if (
                      (h =
                        'waterfall' === a.type
                          ? g.dataPointEOs[t].cumulativeSum
                          : g.dataPoints[t].y) &&
                      h.length
                    )
                      for (var w = 0; w < h.length; w++)
                        (q = Math.floor((h[w] - m) / l)),
                          h[w] < d[q].min && (d[q].min = h[w]),
                          h[w] > d[q].max && (d[q].max = h[w]);
                    else
                      s(h) ||
                        ((q = Math.floor((h - m) / l)),
                        h < d[q].min && (d[q].min = h),
      ...
      for (var c, e = this, f = !1, p = 0; p < this._axes.length; p++)
        if (
          this._axes[p].scaleBreaks &&
          this._axes[p].scaleBreaks.autoCalculate &&
          1 <= this._axes[p].scaleBreaks.maxNumberOfAutoBreaks
        ) {
          f = !0;
          ...
          for (
            ...
            100 /
              Math.max(
                parseFloat(this._axes[p].scaleBreaks.collapsibleThreshold) ||
                  10,
                10
              );
            t++
          )
            this._axes[p].dataInfo._dataRanges.push({
              min: Infinity,
              max: -Infinity,
            });
        }
      if (f) {
        for (p = 0; p < this.plotInfo.plotTypes.length; p++)
          for (
            f = this.plotInfo.plotTypes[p], t = 0;
        ...
        for (p = 0; p < this._axes.length; p++)
          if (this._axes[p].dataInfo._dataRanges) {
            ...
            if (this._axes[p].scaleBreaks.customBreaks)
              for (
                t = 0;
                t < this._axes[p].scaleBreaks.customBreaks.length;
                t++
              )
                for (c = 0; c < f.length; c++)
                  if (
                    (this._axes[p].scaleBreaks.customBreaks[t].startValue <=
                      f[c].start &&
                      f[c].start <=
                        this._axes[p].scaleBreaks.customBreaks[t].endValue) ||
                    (this._axes[p].scaleBreaks.customBreaks[t].startValue <=
                      f[c].start &&
                      f[c].start <=
                        this._axes[p].scaleBreaks.customBreaks[t].endValue) ||
            ...
            for (
              ...
              Math.min(
                f.length,
                this._axes[p].scaleBreaks.maxNumberOfAutoBreaks
              );
              t++
            )
              (c = a(
                f[t].start,
                f[t].end,
                this._axes[p].logarithmic
                  ? this._axes[p].dataInfo.max / this._axes[p].dataInfo.min
                  : this._axes[p].dataInfo.max - this._axes[p].dataInfo.min,
                this._axes[p].logarithmic
              )),
                this._axes[p].scaleBreaks.autoBreaks.push(
                  new T(
                    this,
                    'autoBreaks',
                    c,
                ...
                this._axes[p].scaleBreaks._appliedBreaks.push(
                  this._axes[p].scaleBreaks.autoBreaks[
                    this._axes[p].scaleBreaks.autoBreaks.length - 1
                  ]
                );
    ...
    l.prototype.getDataPointAtXY = function (a, d, b) {
      ...
      for (var c = [], e = this._dataInRenderedOrder.length - 1; 0 <= e; e--) {
        var f = null;
        (f = this._dataInRenderedOrder[e].getDataPointAtXY(a, d, b)) &&
          c.push(f);
      }
      a = null;
      d = !1;
      for (b = 0; b < c.length; b++)
        if (
          ...
          if (
            ((e = la('markerSize', c[b].dataPoint, c[b].dataSeries) || 8),
            c[b].distance <= e / 2)
          ) {
            d = !0;
            break;
      ...
      if (a.changedTouches && this.interactivityEnabled) {
        ...
        if (!(b && 1 < b.length)) {
          ...
          try {
            ...
            if (
              (1 < Math.abs(p) && this._lastTouchData.scroll) ||
              (5 < Math.abs(p) && 250 > f)
            )
      ...
      for (var e = 0; e < c.length; e++)
        if ((s(b[c[e]]) && (b[c[e]] = []), 'axisY' === c[e]))
          for (var f = 0; f < this.axisY.length; f++)
            b[c[e]].push({
              viewportMinimum:
                this[c[e]][f].sessionVariables.newViewportMinimum,
              viewportMaximum:
                this[c[e]][f].sessionVariables.newViewportMaximum,
            });
        else if ('axisY2' === c[e])
      ...
      l.capturedEventParam &&
        ...
        c.hasOwnProperty(b) &&
          ('mouseup' !== b || c.chart.overlaidCanvas.releaseCapture
            ? (a.target !== c.chart.overlaidCanvas && w) ||
      ...
      if (
        ...
        if (this.panEnabled || this.zoomEnabled) {
          if (this.panEnabled)
            ...
            2 < Math.abs(b - e) &&
              2 < Math.abs(c - f) &&
              this._zoomPanToSelectedRegion(b, c, e, f) &&
              (p = !0);
          }
          p &&
      ...
      if ('none' !== this.plotInfo.axisPlacement) {
        ...
        if (this.axisX && 0 < this.axisX.length)
          for (p = 0; p < this.axisX.length; p++)
            this.axisX[p].crosshair &&
              this.axisX[p].crosshair.enabled &&
              this.axisX[p].renderCrosshair(a, d);
        if (this.axisX2 && 0 < this.axisX2.length)
          for (p = 0; p < this.axisX2.length; p++)
            this.axisX2[p].crosshair &&
              this.axisX2[p].crosshair.enabled &&
              this.axisX2[p].renderCrosshair(a, d);
        if (this.axisY && 0 < this.axisY.length)
          for (p = 0; p < this.axisY.length; p++)
            this.axisY[p].crosshair &&
              this.axisY[p].crosshair.enabled &&
              this.axisY[p].renderCrosshair(a, d);
        if (this.axisY2 && 0 < this.axisY2.length)
          for (p = 0; p < this.axisY2.length; p++)
            this.axisY2[p].crosshair &&
              this.axisY2[p].crosshair.enabled &&
              this.axisY2[p].renderCrosshair(a, d);
      }
    };
    l.prototype._plotAreaMouseMove = function (a, d) {
      if (this.isDrag && 'none' !== this.plotInfo.axisPlacement) {
        ...
        if (
          (!e || 2 < Math.abs(b) || !f || 2 < Math.abs(c)) &&
          (this.panEnabled || this.zoomEnabled)
        )
          if (this.panEnabled)
            (e = {
              x1: e ? this.plotArea.x1 + b : this.plotArea.x1,
              y1: f ? this.plotArea.y1 + c : this.plotArea.y1,
              x2: e ? this.plotArea.x2 + b : this.plotArea.x2,
              y2: f ? this.plotArea.y2 + c : this.plotArea.y2,
            }),
                    ...
                    p._zoomPanToSelectedRegion(c, b, e, f, !0) &&
                      ...
                      p.stockChart &&
                        ...
                        ((p.stockChart._rangeEventParameter.type =
                          'rangeChanging'),
                        p.stockChart.dispatchEvent(
                          'rangeChanging',
                          p.stockChart._rangeEventParameter,
                          p.stockChart
                        )),
                      p.render(),
      ...
      for (p = 0; p < k.length; p++) {
        ...
        if (q > h)
          var r = h,
            ...
            q = r;
        if (n.scaleBreaks)
          for (r = 0; !f && r < n.scaleBreaks._appliedBreaks.length; r++)
            f =
              n.scaleBreaks._appliedBreaks[r].startValue <= q &&
              n.scaleBreaks._appliedBreaks[r].endValue >= h;
          ...
          if (
            ...
            !(
              ...
              (!(
                ...
                ((n.logarithmic && r < Math.pow(n.dataInfo.minDiff, 3)) ||
                  (!n.logarithmic && r < 3 * Math.abs(n.dataInfo.minDiff)))) ||
              q < n.minimum ||
              h > n.maximum
            ))
          )
    ...
    l.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        if (null !== D && '' !== D) {
          ...
          p = t = 2;
          'horizontal' === C
            ? ((B = g.width), (k = g.height))
            : ((k = g.width), (B = g.height));
          if ('normal' === this.plotInfo.axisPlacement) {
            ...
            'inside' !== A
              ? ((e = b.y1),
                ...
                0 < v
                  ? ((h =
                      m.point.y + ('horizontal' === C ? r / 2 : 0) - k - t - c),
                    h < e &&
                      ((h =
                        'auto' === A
                ...
                (c =
                  0 <= n.indexOf('range') || 'error' === n
                    ...
                    : (Math.max(m.bounds.y1, b.y1) +
                      ...
                      ('horizontal' === C ? t : 0)),
                0 < v
                  ? ((h = Math.max(m.point.y, c)),
                    h < e &&
                      ('bubble' === n || 'scatter' === n) &&
                      (h = Math.max(m.point.y - k - t, b.y1 + t)))
                  : ((h = Math.min(m.point.y, c)),
                    h > f - k - t &&
                      ('bubble' === n || 'scatter' === n) &&
                      (h = Math.min(m.point.y + t, b.y2 - k - t))),
                (h = Math.min(h, f)));
          } else
            0 <= n.indexOf('line') ||
            0 <= n.indexOf('area') ||
            0 <= n.indexOf('scatter')
              ...
              'inside' !== A
                ? ((e = b.x1),
                  ...
                  0 > v
                    ? ((q =
                      ...
                      q < e &&
                        ((q =
                          'auto' === A ? Math.max(m.point.x, e) + p : e + p),
                        (y = q + B > m.point.x)))
                    : ((q =
                        m.point.x + ('horizontal' === C ? 0 : r / 2) + p + c),
                      q > f - B - p - c &&
                        ((q =
                          'auto' === A
                ...
                : ((e = Math.max(m.bounds.x1, b.x1)),
                  ...
                  (q =
                    0 > v
                      ? Math.max(m.point.x, c) -
                        ('horizontal' === C ? B / 2 : 0)
                      : Math.min(m.point.x, c) - B / 2),
                  (q = Math.max(q, e)));
          'vertical' === C && (h += k - r / 2);
          g.x = q;
          g.y = h;
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (m = this._indexLabels[a]),
          (g = la('indexLabelBackgroundColor', m.dataPoint, m.dataSeries)),
          (m.dataSeries.indexLabelBackgroundColor = s(g)
            ? w
              ? 'transparent'
              : null
            : g);
                  ...
                  l || C
                    ...
                    : (b.lineTo(x, s),
                      ...
                      0 == u % 500 &&
                        ...
                        b.beginPath(),
                        b.moveTo(x, s),
                        w && (c.stroke(), c.beginPath(), c.moveTo(x, s))));
                  p = { x: x, y: s };
                  u < m.length - 1 &&
                    (g !== (m[u].lineColor || r) ||
                    ...
                    b.setLineDash &&
                      (m[u].lineDashType
                        ? ((n = m[u].lineDashType),
                          b.setLineDash(N(n, k.lineThickness)))
                        : ((n = k.lineDashType), b.setLineDash(h))));
                  ...
                  u < m.length - 1 &&
                    ...
                    b.setLineDash &&
                      (m[u].lineDashType
                        ...
                        : ((n = k.lineDashType), b.setLineDash(h))));
                  if (0 < m[u].markerSize || 0 < k.markerSize)
                    (D = k.getMarkerProperties(u, x, s, b)),
                      f.push(D),
                      (z = P(z)),
                      w &&
                        f.push({
        ...
        for (var p = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < m.length)
            for (x = !1, l = 0; l < m.length; l++)
              if (
                ((u = m[l].getTime ? m[l].x.getTime() : m[l].x),
                !(
                ...
                if ('number' !== typeof m[l].y)
                  ...
                  l < m.length - 1 &&
                    (g !== (m[l].lineColor || r) ||
                      n !== (m[l].lineDashType || k.lineDashType)) &&
                    ((g = m[l].lineColor || r),
    ...
    l.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < r.length)
            for (
              var g = 5 < n && h.bevelEnabled ? !0 : !1, f = 0;
              f < r.length;
              f++
            )
              if (
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                var s =
                    (m - (a.plotType.plotUnits.length * h) / 2 + a.index * h) <<
                    0,
                  C = (s + h) << 0,
                  D;
                if (
                  ...
                  (B[c] = u[k].y + (B[c] ? B[c] : 0)),
                    (D = a.axisY.convertValueToPixel(B[c])),
                    (n = 'undefined' !== typeof p[c] ? p[c] : q),
                    (p[c] = D);
                else if (
    ...
    l.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < u.length)
            for (
              var x = 5 < h && l.bevelEnabled ? !0 : !1, k = 0;
              k < u.length;
              k++
            )
              if (
                ...
                if (
                  ...
                  (B[c] = n + ('undefined' !== typeof B[c] ? B[c] : 0)),
                    (D = a.axisY.convertValueToPixel(B[c])),
                    (n = p[c] ? p[c] : q),
                    (p[c] = D);
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                var s =
                    (n - (a.plotType.plotUnits.length * h) / 2 + a.index * h) <<
                    0,
                  C = (s + h) << 0,
                  D;
                if (
                  ...
                  (B[c] = u[k].y + (B[c] ? B[c] : 0)),
                    (m = p[c] ? p[c] : q),
                    (p[c] = D = a.axisY.convertValueToPixel(B[c]));
                else if (
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (B[c] = A + (B[c] ? B[c] : 0)),
                    (m = p[c] ? p[c] : q),
                    (p[c] = A = a.axisY.convertValueToPixel(B[c]));
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < r.length) {
            ...
            for (var ja = !0; g < r.length; g++)
              if (
                ((s = r[g].x.getTime ? r[g].x.getTime() : r[g].x),
                !(
                  s < a.axisX.dataInfo.viewPortMin ||
                  (s > a.axisX.dataInfo.viewPortMax &&
                    (!h.connectNullData || !ja))
                ))
              )
                if ('number' !== typeof r[g].y)
                  h.connectNullData || ja || d || c(), (ja = !0);
                else {
                  ...
                  d || ja
                    ? (!d && h.connectNullData
                        ? (f.setLineDash &&
                            ...
                            (u = b),
                            (D = m),
                            (b = h.nullDataLineDashType),
                            f.setLineDash(Q)),
                          f.lineTo(l, u),
                          w && p.lineTo(l, u))
                        : (f.beginPath(),
                          f.moveTo(l, u),
                          w && (p.beginPath(), p.moveTo(l, u)),
                          (D = { x: l, y: u })),
                      (ja = d = !1))
                    : (f.lineTo(l, u),
                      w && p.lineTo(l, u),
                  ...
                  g < r.length - 1 &&
                    (y !== (r[g].lineColor || v) ||
                      b !== (r[g].lineDashType || h.lineDashType)) &&
                    (c(),
                    (y = r[g].lineColor || v),
                    (f.strokeStyle = y),
                    f.setLineDash &&
                      (r[g].lineDashType
                        ? ((b = r[g].lineDashType),
                          f.setLineDash(N(b, h.lineThickness)))
                        : ((b = h.lineDashType), f.setLineDash(aa))));
                  ...
                  0 !== r[g].markerSize &&
                    ...
                    ((s = h.getMarkerProperties(g, l, u, f)),
                    B.push(s),
                    (Y = P(Y)),
                    w &&
                      B.push({
                  ...
                  (r[g].indexLabel ||
                    ...
                    this._indexLabels.push({
                      ...
                      dataSeries: h,
                      point: { x: l, y: u },
                      direction: 0 > r[g].y === a.axisY.reversed ? 1 : -1,
                      color: z,
                    });
                }
            c();
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          if (0 < n.length) {
            ...
            for (r = !1; q < n.length; q++)
              if (
                ((h = n[q].x.getTime ? n[q].x.getTime() : n[q].x),
                !(
                ...
                if ('number' !== typeof n[q].y)
                  ...
                  q < n.length - 1 &&
                    (D !== (n[q].lineColor || C) ||
                      z !== (n[q].lineDashType || m.lineDashType)) &&
                    ((D = n[q].lineColor || C),
              ...
              if (
                ...
                'number' !== typeof r[g].y
                  ...
                  : ((l = a.axisX.convertValueToPixel(s)),
                    ...
                    g < r.length - 1 &&
                      (y !== (r[g].lineColor || v) ||
                        Q !== (r[g].lineDashType || h.lineDashType)) &&
                      (c(),
                      (y = r[g].lineColor || v),
                      (f.strokeStyle = y),
                      f.setLineDash &&
                        (r[g].lineDashType
                          ? ((Q = r[g].lineDashType),
                            f.setLineDash(N(Q, h.lineThickness)))
                          : ((Q = h.lineDashType), f.setLineDash(E)))),
                    (s = h.dataPointIds[g]),
                    ...
                    0 !== r[g].markerSize &&
                      (0 < r[g].markerSize || 0 < h.markerSize) &&
                      ((Y = h.getMarkerProperties(g, l, u, f)),
                      B.push(Y),
                      (s = P(s)),
                      w &&
                        B.push({
                ...
                if ('number' !== typeof fa.y)
                  ...
                  q < v.length - 1 &&
                    ...
                    c.setLineDash &&
                      (v[q].lineDashType
                        ? ((A = v[q].lineDashType),
                          c.setLineDash(N(A, z.lineThickness)))
                        : ((A = z.lineDashType), c.setLineDash(E))));
                ...
                if ('number' !== typeof fa.y)
                  ...
                  q < y.length - 1 &&
                    ...
                    c.setLineDash &&
                      (y[q].lineDashType
                        ? ((u = y[q].lineDashType),
                          c.setLineDash(N(u, z.lineThickness)))
                        : ((u = z.lineDashType), c.setLineDash(F))));
                  if (0 <= z.dataPointIndexes[f]) {
                  ...
                  0 <= z.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < z.markerSize) &&
                    ((ba = z.getMarkerProperties(q, h, r, c)),
                    t.push(ba),
                    (f = P(G)),
                    w &&
                      t.push({
    ...
    l.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          if (0 < A.length)
            for (
              var C = 5 < r && x.bevelEnabled ? !0 : !1, p = 0;
              p < A.length;
              p++
            )
              if (
                ...
                var D = (t - r / 2) << 0,
                  ...
                  Q = A[p].whiskerColor
                    ...
                    : e,
                  aa =
                    'number' === typeof A[p].whiskerThickness
                      ? A[p].whiskerThickness
                      : 'number' === typeof x.options.whiskerThickness
                      ? x.whiskerThickness
                      : y,
                  F = A[p].whiskerDashType
                    ? A[p].whiskerDashType
                    : x.whiskerDashType,
                  ...
                  ma = A[p].stemColor
                    ...
                    : e,
                  ba =
                    'number' === typeof A[p].stemThickness
                      ? A[p].stemThickness
                  ...
                  H = A[p].lineColor
                    ...
                    : e,
                  M =
                    'number' === typeof A[p].lineThickness
                      ? A[p].lineThickness
                ...
                0 < ba &&
                  ...
                  (b.strokeStyle = ma),
                  (b.lineWidth = ba),
                  b.setLineDash && b.setLineDash(N(J, ba)),
                  b.moveTo(t - G, k),
                  b.lineTo(t - G, g),
                  b.stroke(),
                  b.moveTo(t - G, n),
                ...
                0 < M &&
                  (b.beginPath(),
                  (b.globalAlpha = 1),
                  b.setLineDash && b.setLineDash(N(S, M)),
                  (b.strokeStyle = H),
                  (b.lineWidth = M),
                  b.moveTo(D, q - L),
                  b.lineTo(z, q - L),
                ...
                w &&
                  ...
                  0 < ba &&
                    (c.moveTo(t - E - G, k),
                    c.lineTo(t - E - G, Math.max(g, n)),
                    c.stroke(),
                    c.moveTo(t - E - G, Math.min(g, n)),
                    c.lineTo(t - E - G, m),
                    c.stroke()),
                  ca(
                    c,
            ...
            for (
              ...
              if (
                ...
                !(
                  ...
                  !s(h[f].y) &&
                  h[f].y.length &&
                  'number' === typeof h[f].y[0] &&
                  'number' === typeof h[f].y[1])
              ) {
              ...
              if (
                ...
                c
                  ? ((q = a.axisX.reversed
                      ...
                      : (k - ((z ? v : 1) * u) / 2 + (z ? E - 1 : 0) * u) << 0),
                    (h = a.axisX.reversed ? (q - u) << 0 : (q + u) << 0))
                  : ((m = a.axisX.reversed
                      ? (g + ((z ? v : 1) * u) / 2 - (z ? E - 1 : 0) * u) << 0
                      : (g - ((z ? v : 1) * u) / 2 + (z ? E - 1 : 0) * u) << 0),
                ...
                if (
                  ...
                  this._indexLabels.push({
                    ...
                    indexKeyword: 0,
                    point: {
                      x: c ? (D[t].y[1] >= D[t].y[0] ? m : n) : m + (n - m) / 2,
                      y: c ? q + (h - q) / 2 : D[t].y[1] >= D[t].y[0] ? h : q,
                    },
                      ...
                      point: {
                        x: c
                          ? D[t].y[1] >= D[t].y[0]
                            ...
                            : m
                          : m + (n - m) / 2,
                        y: c ? q + (h - q) / 2 : D[t].y[1] >= D[t].y[0] ? q : h,
                      },
                      direction: D[t].y[1] >= D[t].y[0] ? 1 : -1,
                      bounds: {
                        x1: c ? Math.min(m, n) : m,
    ...
    l.prototype.renderRangeArea = function (a) {
      function d() {
        if (x) {
          for (var a = null, b = g.length - 1; 0 <= b; b--)
            (a = g[b]), c.lineTo(a.x, a.y2), e.lineTo(a.x, a.y2);
          c.closePath();
          c.globalAlpha = m.fillOpacity;
          c.fill();
          c.globalAlpha = 1;
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < n.length) {
            ...
            for (var Q = !0; h < n.length; h++)
              if (
                ((u = n[h].x.getTime ? n[h].x.getTime() : n[h].x),
                !(
                  u < a.axisX.dataInfo.viewPortMin ||
                  (u > a.axisX.dataInfo.viewPortMax &&
                    (!m.connectNullData || !Q))
                ...
                if (
                  null !== n[h].y &&
                  n[h].y.length &&
                  'number' === typeof n[h].y[0] &&
                  'number' === typeof n[h].y[1]
                ) {
                  ...
                  h < n.length - 1 &&
                    (D !== (n[h].lineColor || C) ||
                      z !== (n[h].lineDashType || m.lineDashType)) &&
                    (d(),
                    (D = n[h].lineColor || C),
                    ...
                    c.setLineDash &&
                      (n[h].lineDashType
                        ? ((z = n[h].lineDashType),
                          (g[g.length - 1].newLineDashArray = N(
                            z,
                            m.lineThickness
                          )),
                          c.setLineDash(g[g.length - 1].newLineDashArray))
                        : ((z = m.lineDashType),
                          (g[g.length - 1].newLineDashArray = E),
                          c.setLineDash(E))));
                  if (
                    0 !== n[h].markerSize &&
                    (0 < n[h].markerSize || 0 < m.markerSize)
                  ) {
                  ...
                  if (
                    ...
                    this._indexLabels.push({
                      ...
                      point: { x: r, y: l },
                      direction:
                        n[h].y[0] > n[h].y[1] === a.axisY.reversed ? -1 : 1,
                      color: v,
                    }),
                      this._indexLabels.push({
                        chartType: 'rangeArea',
            ...
            for (var h = (f = 0); f < d.length - 3; f += 3, h++) {
              if (l[h].newStrokeStyle || l[h].newLineDashArray)
                c.stroke(),
                  c.beginPath(),
                  c.moveTo(d[f].x, d[f].y),
                  l[h].newStrokeStyle && (c.strokeStyle = l[h].newStrokeStyle),
                  l[h].newLineDashArray && c.setLineDash(l[h].newLineDashArray);
              c.bezierCurveTo(
                d[f + 1].x,
                d[f + 1].y,
                d[f + 2].x,
            ...
            for (h = !1; n < m.length; n++)
              if (
                ...
                if (
                  ...
                  n < m.length - 1 &&
                    (A !== (m[n].lineColor || x) ||
                      C !== (m[n].lineDashType || k.lineDashType)) &&
                    ((A = m[n].lineColor || x),
                    (l[l.length - 1].newStrokeStyle = A),
                    c.setLineDash &&
                      (m[n].lineDashType
                        ? ((C = m[n].lineDashType),
                          (l[l.length - 1].newLineDashArray = N(
                            C,
                            k.lineThickness
                          )))
                        : ((C = k.lineDashType),
                  ...
                  0 < n &&
                    ...
                    (k.connectNullData
                      ? c.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !m[n - 1].lineDashType) &&
                        ((l[l.length - 1].newLineDashArray = z),
        ...
        for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
          ...
          if (0 < v.length)
            for (
              ...
              if (
                (v[p].getTime ? (m = v[p].x.getTime()) : (m = v[p].x),
                'number' !== typeof v[p].y)
              ) {
                if (0 < p && !C && s.connectNullData)
                  var y =
                    s.options.nullDataLineDashType || !v[p - 1].lineDashType
                ...
                g =
                  0 === s.dataPointEOs[p].cumulativeSum
                    ? n
                    : a.axisY.convertValueToPixel(
                        s.dataPointEOs[p].cumulativeSum
                      );
                k =
                  0 === s.dataPointEOs[p].cumulativeSumYStartValue
                    ? n
                    : a.axisY.convertValueToPixel(
                        s.dataPointEOs[p].cumulativeSumYStartValue
                      );
                t = a.axisX.reversed
                  ? (t +
                      (a.plotType.totalDataSeries * q) / 2 -
                      (a.previousDataSeriesCount + h) * q) <<
                    0
                  : (t -
                      (a.plotType.totalDataSeries * q) / 2 +
                      (a.previousDataSeriesCount + h) * q) <<
                ...
                var aa,
                  Q = t;
                aa =
                  ('undefined' !== typeof v[p].isIntermediateSum &&
                    !0 === v[p].isIntermediateSum) ||
                  ('undefined' !== typeof v[p].isCumulativeSum &&
                    !0 === v[p].isCumulativeSum)
                    ? 0 < v[p].y
                      ? g
                      : k
                    : 0 < v[p].y
    ...
    l.prototype.renderPie = function (a) {
      function d() {
        if (k && m) {
          for (var a = 0, c = 0, b = 0, d = 0, e = 0; e < m.length; e++) {
            ...
            g.indexLabelLineColor = f.indexLabelLineColor
            ...
            g.indexLabelLineThickness = s(f.indexLabelLineThickness)
              ? k.indexLabelLineThickness
              : f.indexLabelLineThickness;
            g.indexLabelLineDashType = f.indexLabelLineDashType
              ? f.indexLabelLineDashType
              : k.indexLabelLineDashType;
            g.indexLabelFontColor = f.indexLabelFontColor
              ? f.indexLabelFontColor
              : k.indexLabelFontColor;
            g.indexLabelFontStyle = f.indexLabelFontStyle
              ? f.indexLabelFontStyle
              : k.indexLabelFontStyle;
            g.indexLabelFontWeight = f.indexLabelFontWeight
              ? f.indexLabelFontWeight
              : k.indexLabelFontWeight;
            g.indexLabelFontSize = s(f.indexLabelFontSize)
              ? k.indexLabelFontSize
              : f.indexLabelFontSize;
            g.indexLabelFontFamily = f.indexLabelFontFamily
              ? f.indexLabelFontFamily
              : k.indexLabelFontFamily;
            g.indexLabelBackgroundColor = f.indexLabelBackgroundColor
              ? f.indexLabelBackgroundColor
              : k.options.indexLabelBackgroundColor
              ? k.options.indexLabelBackgroundColor
              : k.indexLabelBackgroundColor;
            g.indexLabelMaxWidth = f.indexLabelMaxWidth
            ...
            g.indexLabelWrap =
              'undefined' !== typeof f.indexLabelWrap
                ? f.indexLabelWrap
                : k.indexLabelWrap;
            g.indexLabelTextAlign = f.indexLabelTextAlign
            ...
            g.indexLabelTextBlock = new ia(l.plotArea.ctx, {
              ...
              maxHeight: g.indexLabelWrap
                ? 5 * g.indexLabelFontSize
                : 1.5 * g.indexLabelFontSize,
          ...
          for (e = 0; e < m.length; e++)
            (g = h[(b + e) % m.length]),
              1 < a &&
                g.midAngle > Math.PI / 2 - u &&
                g.midAngle < Math.PI / 2 + u &&
                (f <= a / 2 && !n
                  ? ((g.hemisphere = 'right'), f++)
                  : ((g.hemisphere = 'left'), (n = !0)));
          n = !1;
          for (e = 0; e < m.length; e++)
            (g = h[(d + e) % m.length]),
              1 < c &&
      ...
      function b(a) {
        ...
        for (c = 0; c < m.length; c++) {
          ...
          if (d > b) {
            ...
            if (m[c].exploded) {
              if (
                1e-9 < Math.abs(h[c].center.x - (A.x + e)) ||
                1e-9 < Math.abs(h[c].center.y - (A.y + f))
              )
                (h[c].center.x = A.x + e * a),
                  (h[c].center.y = A.y + f * a),
                  (p = !0);
            } else if (
              0 < Math.abs(h[c].center.x - A.x) ||
              0 < Math.abs(h[c].center.y - A.y)
            )
              (h[c].center.x = A.x + e * (1 - a)),
                (h[c].center.y = A.y + f * (1 - a)),
                (p = !0);
            p &&
              ((e = {}),
              (e.dataSeries = k),
              (e.dataPoint = k.dataPoints[c]),
              (e.index = c),
          ...
          (b = h[c]),
            b.indexLabelText &&
              ...
              'inside' !== b.indexLabelPlacement &&
                ...
                a.setLineDash &&
                  a.setLineDash(
                    N(b.indexLabelLineDashType, b.indexLabelLineThickness)
                  ),
                a.beginPath(),
                a.moveTo(d, e),
                a.lineTo(b.indexLabelTextBlock.x, b.indexLabelTextBlock.y),
                a.lineTo(
                  b.indexLabelTextBlock.x + ('left' === b.hemisphere ? -n : n),
                  b.indexLabelTextBlock.y
                ),
                a.stroke()),
              (a.lineJoin = 'miter'));
        a.save();
      ...
      function c(a, c) {
        ...
        return (b =
          c.indexLabelTextBlock.y > a.indexLabelTextBlock.y ? e - d : b - f);
      }
      function e(a) {
        for (var b = null, d = 1; d < m.length; d++)
          if (
            ((b = (a + d + h.length) % h.length),
            h[b].hemisphere !== h[a].hemisphere)
          ) {
            b = null;
            break;
          } else if (
            ...
            b !== a &&
            (0 > c(h[b], h[a]) ||
              ('right' === h[a].hemisphere
                ? h[b].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y
                : h[b].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y))
          )
            break;
          else b = null;
      ...
      function f(a, b, d) {
        ...
        if (0 <= a && a < m.length) {
          var n = h[a];
          if (
            (0 > b && n.indexLabelTextBlock.y < p) ||
            (0 < b && n.indexLabelTextBlock.y > g)
          )
            return 0;
          var q = 0,
            t = 0,
            t = (q = q = 0);
          0 > b
            ? n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 > p &&
          ...
          p =
            'right' === n.hemisphere
              ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(b - A.y, 2))
              : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(b - A.y, 2));
          ...
          for (g = 1; g < m.length; g++)
            if (
              ...
              (0 > c(h[p], h[a]) ||
                ('right' === h[a].hemisphere
                  ? h[p].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y
                  : h[p].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y))
            )
              break;
            else p = null;
            ...
            ? ((g = 'right' === n.hemisphere ? t : q),
              ...
              null !== g &&
                ...
                (b =
                  n.indexLabelTextBlock.y -
                  n.indexLabelTextBlock.height / 2 -
                  (h[g].indexLabelTextBlock.y +
                    h[g].indexLabelTextBlock.height / 2)),
                b - t < r &&
                  ((p = -t),
                  (g = f(g, p, d + 1)),
                  +g.toFixed(x) > +p.toFixed(x) &&
                    (k = b > r ? -(b - r) : -(t - (g - p))))))
            : 0 < b &&
          ...
          k &&
            ...
            (n.indexLabelAngle = Math.atan2(
              n.indexLabelTextBlock.y - A.y,
              n.indexLabelTextBlock.x - A.x
            )));
        }
        return k;
      }
      function p() {
        ...
        for (
          ...
          if ('inside' !== k.indexLabelPlacement) {
              ...
              if (null !== s) {
                ...
                if (0 > C) {
                  for (var D = (u = 0), F = 0; F < m.length; F++)
                    F !== a &&
                      h[F].hemisphere === g.hemisphere &&
                      (h[F].indexLabelTextBlock.y < g.indexLabelTextBlock.y
                        ? u++
                        : D++);
                  u = (C / (u + D || 1)) * D;
                  var D = -1 * (C - u),
            ...
            for (a = 0; a < m.length; a++)
              (g = h[a]),
                ...
                (s = A.x + w * Math.cos(g.midAngle)),
                (u = A.y + w * Math.sin(g.midAngle)),
                (g.indexLabelTextBlock.x = s),
                (g.indexLabelTextBlock.y = u);
          for (a = 0; a < m.length; a++)
            if (
              ((g = h[a]),
              (s = g.indexLabelTextBlock.measureText()),
              ...
              (s = s = 0),
                'right' === g.hemisphere
                  ? ((s =
                      q.x2 -
                      (g.indexLabelTextBlock.x +
                        g.indexLabelTextBlock.width +
                        n)),
                    (s *= -1))
                  : (s =
                      q.x1 -
                ...
                0 < s &&
                  (!p &&
                    ...
                    ((u =
                      'right' === g.hemisphere
                        ? q.x2 - g.indexLabelTextBlock.x
                        : g.indexLabelTextBlock.x - q.x1),
                    0.3 * g.indexLabelTextBlock.maxWidth > u
                      ? (g.indexLabelText = '')
                      : (g.indexLabelTextBlock.maxWidth = 0.85 * u),
                    0.3 * g.indexLabelTextBlock.maxWidth < u &&
                      (g.indexLabelTextBlock.x -=
                        'right' === g.hemisphere ? 2 : -2)),
                  Math.abs(
                  ...
                  ((s /= Math.abs(Math.cos(g.indexLabelAngle))),
                  9 < s && (s *= 0.3),
                  s > d && (d = s)),
                (s = s = 0),
                  ...
                  (!p &&
                    ...
                    ((u =
                      0 < g.indexLabelAngle && g.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === f(a, s * u) && f(a, 2 * u)),
                  Math.abs(g.indexLabelTextBlock.x - A.x) < z &&
                    ((s /= Math.abs(Math.sin(g.indexLabelAngle))),
                    9 < s && (s *= 0.3),
                    s > d && (d = s)));
          var H = function (a, c, b) {
            ...
            for (c = 0; c < d.length; c++)
              if (((b = d[c]), e < 0.7 * a))
                (e += b.indexLabelTextBlock.height),
                  (b.indexLabelTextBlock.text = ''),
                  (b.indexLabelText = ''),
                  b.indexLabelTextBlock.measureText();
              else break;
          };
          (function () {
        ...
        if (l.subtitles)
          for (var a = 0; a < l.subtitles.length; a++) {
            ...
            (c.dockInsidePlotArea ||
              ('center' === c.horizontalAlign &&
                'center' === c.verticalAlign)) &&
              c.render();
          }
        l.legend &&
        ...
        if (0 !== C) {
          ...
          this._animator.animate(
            ...
            function (a) {
              ...
              c.fillRect(q.x1, q.y1, q.width, q.height);
              for (
                var c = h[0].startAngle + 2 * Math.PI * a, b = 0;
                b < m.length;
                b++
              ) {
    ...
    l.prototype.renderFunnel = function (a) {
      function d() {
        ...
        if (0 === a) return -1;
        for (b = c[0] = 0; b < x.length; b++)
          c.push((Math.abs(x[b].y) * E) / a);
        return c;
      }
      function b() {
        var a = X,
        ...
        if (0 === h) return -1;
        for (
          var p = (d[0] = 0), g = 0, m, n, b = b - a, p = !1, k = 0;
          k < x.length;
          k++
        )
        ...
        if (e)
          for (p = I.length - 1; 0 <= p; p--)
            (a = O[p]),
              ...
              (I[p].textBlock.x = M - k),
              (c =
                I[p].textBlock.height < I[p].textBlock.maxHeight
                  ? I[p].textBlock.height
                  : I[p].textBlock.maxHeight),
              (e =
                I[p].textBlock.width < I[p].textBlock.maxWidth
                  ? I[p].textBlock.width
                  : I[p].textBlock.maxWidth),
              (I[p].height = c),
              (I[p].width = e),
              (c =
              ...
              u.reversed
                ? (I[p].textBlock.y + I[p].height > na + C &&
                    (I[p].textBlock.y = na + C - I[p].height),
                  I[p].textBlock.y < sa - C && (I[p].textBlock.y = sa - C))
                : (I[p].textBlock.y < na - C && (I[p].textBlock.y = na - C),
                  I[p].textBlock.y + I[p].height > sa + C &&
                    (I[p].textBlock.y = sa + C - I[p].height));
      }
      function f() {
        var a, b, c, d;
          ...
          for (var p, g = 1; g < k; g++) {
            ...
            for (var t = I.length - 1; 0 <= t; t--)
              !I[t].isDirty &&
                ...
                ((p = q(t)),
                !(p >= I.length - 1) &&
                  I[t].textBlock.y + I[t].height + da > I[p].textBlock.y &&
                  (I[t].textBlock.y =
      ...
      function l(a, b, c) {
        ...
        if (0 === W.length) p = ga;
          ...
          e =
            (C *
              (1 != W.length || (0 != W[0] && W[0] != O.length - 1) ? 2 : 1)) /
            k();
          for (var t = 0; t < O.length; t++) {
            ...
            p.push(ga[t] + d);
            if (0 <= W.indexOf(t) || (t < O.length && 0 <= W.indexOf(t + 1)))
              d += e;
          }
        }
        h = (function () {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== x.length) {
          ...
          if (-1 !== H) {
            if (u.reversed)
              for (F.push(T), G = H.length - 1; 0 < G; G--)
                (T += H[G]), F.push(T);
            ...
            for (G = 0; G < x.length; G++)
              x[G].exploded &&
                ((H = !0), u.reversed ? W.push(x.length - 1 - G) : W.push(G));
            ...
            if (
              J &&
              u.visible &&
              (c(), f(), e(), 'inside' !== u.indexLabelPlacement)
            ) {
              p();
              for (G = 0; G < x.length; G++)
                I[G].isDirty ||
            ...
            !y.animationEnabled && H
              ? l(y, -1, 0)
              : y.animationEnabled && !y.animatedRender && l(y, -1, 0);
    ...
    l.prototype.exportChart = function (a) {
      ...
      if (c && d && b) {
        ...
        if ('undefined' !== typeof Blob && new Blob()) {
          for (
            var p = c.replace(/^data:[a-z\/]*;base64,/, ''),
              p = atob(p),
              g = new ArrayBuffer(p.length),
              g = new Uint8Array(g),
              l = 0;
            l < p.length;
            l++
    ...
    l.prototype.replaceKeywordsWithValue = function (a, d, b, c, e) {
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        if ('x' === a)
          if (
            (b.axisX && 'dateTime' === b.axisX.valueType) ||
    ...
    F.prototype.setLayout = function () {
          ...
          if (
            ...
            var q = (n.legendMarkerType = n.legendMarkerType
              ...
              h = n.legendText
                ...
                : n.name,
              r = (n.legendMarkerColor = n.legendMarkerColor
                ? n.legendMarkerColor
                : n.markerColor
                ? n.markerColor
                : 'error' === n.type
            ...
            for (var x = 0; x < n.dataPoints.length; x++) {
              ...
              (A.showInLegend || (n.showInLegend && !1 !== A.showInLegend)) &&
                l.push(q);
            }
      }
      ...
      if (0 < l.length) {
        ...
        this.itemWidth = r;
        this.height =
          !1 === this.itemWrap ? k.length * this.lineHeight : this.height + h;
        ...
        for (var k = p[l], m = 0, n = 0; n < k.items.length; n++) {
          ...
          if (
            ...
            (this.ctx.strokeStyle = q.lineColor),
              ...
              this.ctx.beginPath(),
              this.ctx.moveTo(
                h - 0.1 * this.lineHeight,
                r + this.lineHeight / 2
              ),
              this.ctx.lineTo(
                h + 0.85 * this.lineHeight,
                r + this.lineHeight / 2
              ),
              this.ctx.stroke(),
        ...
        if (0 <= f && f < this.dataPoints.length) {
          var c = this.dataPoints[f],
            n = this.axisX.logarithmic
              ...
              : Math.abs(c.x - a);
          n < b.distance &&
            ((b.dataPoint = c), (b.distance = n), (b.index = f));
          c = n;
          c <= g ? (g = c) : 0 < p ? l++ : k++;
    ...
    E.prototype.createLabels = function () {
      ...
      if (
        ...
        if (this.labels) {
          a = Math.ceil(c);
          for (
            var c = Math.ceil(this.intervalStartPosition), h = !1, b = c;
    ...
    E.setLayout = function (a, d, b, c, e, f) {
      ...
      if (d && 0 < d.length)
        for (h = 0; h < d.length; h++) d[h].calculateAxisParameters();
      if (b && 0 < b.length)
        for (h = 0; h < b.length; h++) b[h].calculateAxisParameters();
      if (c && 0 < c.length)
        for (h = 0; h < c.length; h++) c[h].calculateAxisParameters();
      for (h = 0; h < q.length; h++)
        if (q[h] && q[h].scaleBreaks && q[h].scaleBreaks._appliedBreaks.length)
          for (
            var r = q[h].scaleBreaks._appliedBreaks, w = 0;
            w < r.length && !(r[w].startValue > q[h].viewportMaximum);
            w++
          )
            r[w].endValue < q[h].viewportMinimum ||
              (s(q[h].scaleBreaks.firstBreakIndex) &&
                (q[h].scaleBreaks.firstBreakIndex = w),
              r[w].startValue >= q[h].viewPortMinimum &&
                (q[h].scaleBreaks.lastBreakIndex = w));
      for (
        var v = (w = 0),
          u = 0,
          x = 0,
        ...
        if (q[h].title)
          switch (q[h]._position) {
            case 'left':
              ...
              q[h]._titleTextBlock.maxHeight = q[h].titleWrap
                ? 0.8 * f.width
                : 1.5 * q[h].titleFontSize;
            ...
            case 'right':
              ...
              break;
            default:
              (q[h]._titleTextBlock.maxWidth = q[h].titleMaxWidth || f.width),
                (q[h]._titleTextBlock.maxHeight = q[h].titleWrap
                  ? 0.8 * f.height
                  : 1.5 * q[h].titleFontSize),
                (q[h]._titleTextBlock.angle = 0);
          }
      if ('normal' === e) {
        for (
          var x = [], A = [], y = [], D = [], M = [], N = [], P = [], R = [];
          ...
          var G = 0,
            ...
            $ = 0;
          if (b && 0 < b.length)
            for (y = [], h = O = 0; h < b.length; h++)
              y.push(
                Math.ceil(b[h] ? b[h].createLabelsAndCalculateWidth() : 0)
              ),
                (O += y[h]),
                (L += b[h] && !m.isNavigator ? b[h].margin : 0);
          else
            y.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
          P.push(y);
          if (c && 0 < c.length)
            for (D = [], h = $ = 0; h < c.length; h++)
              D.push(
                Math.ceil(c[h] ? c[h].createLabelsAndCalculateWidth() : 0)
              ),
                ($ += D[h]),
                (Z += c[h] ? c[h].margin : 0);
          else
          ...
          l = Math.round(
            f.x2 - $ - Z > m.width - n ? m.width - n : f.x2 - $ - Z
          );
          if (a && 0 < a.length)
            for (x = [], h = T = 0; h < a.length; h++)
              a[h] && (a[h].lineCoordinates = {}),
                ...
                a[h].title &&
                  (a[h]._titleTextBlock.maxWidth =
                    0 < a[h].titleMaxWidth &&
                    a[h].titleMaxWidth < a[h].lineCoordinates.width
                      ? a[h].titleMaxWidth
                      : a[h].lineCoordinates.width),
                x.push(
                  Math.ceil(a[h] ? a[h].createLabelsAndCalculateHeight() : 0)
                ),
                (T += x[h]),
          ...
          if (d && 0 < d.length)
            for (A = [], h = V = 0; h < d.length; h++)
              d[h] && (d[h].lineCoordinates = {}),
                ...
                d[h].title &&
                  (d[h]._titleTextBlock.maxWidth =
                    0 < d[h].titleMaxWidth &&
                    d[h].titleMaxWidth < d[h].lineCoordinates.width
                      ? d[h].titleMaxWidth
                      : d[h].lineCoordinates.width),
                A.push(
                  Math.ceil(d[h] ? d[h].createLabelsAndCalculateHeight() : 0)
                ),
                (V += A[h]),
            ...
            for (h = 0; h < a.length; h++)
              a[h] &&
                ...
                a[h]._labels &&
                  ...
                  (k = a[h]._labels[1]),
                  (g =
                    'dateTime' === a[h].valueType
                      ? a[h]._labels[a[h]._labels.length - 2]
                      : a[h]._labels[a[h]._labels.length - 1]),
                  (v =
                    k.textBlock.width *
                      Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) +
                    (k.textBlock.height - g.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))),
                  (u =
                    g.textBlock.width *
                      Math.cos((Math.PI / 180) * Math.abs(g.textBlock.angle)) +
                    (g.textBlock.height - g.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(g.textBlock.angle)))),
                !a[h] ||
                  !a[h].labelAutoFit ||
                  s(z) ||
                  s(E) ||
                  ...
                  0 < a[h].labelAngle
                    ? E + u > l &&
                      (g += 0 < a[h].labelAngle ? E + u - l - $ : 0)
                    : 0 > a[h].labelAngle
                    ? z - v < p &&
                      z - v < a[h].viewportMinimum &&
                      (F =
                        p -
                        (L +
                          a[h].tickLength +
                    ...
                    : 0 === a[h].labelAngle &&
                      ...
                      z - v < p &&
                        z - v < a[h].viewportMinimum &&
                        (F = p - L - a[h].tickLength - y - z + v / 2)),
                  a[h].viewportMaximum === a[h].maximum &&
                  a[h].viewportMinimum === a[h].minimum &&
                  0 < a[h].labelAngle &&
                  0 < g
                    ? (l -= g)
                    : a[h].viewportMaximum === a[h].maximum &&
                ...
                'inside' === a[h].labelPlacement &&
                  0 < h &&
                  ((a[h].lineCoordinates.y1 =
                    a[h].lineCoordinates.y1 +
                    x[h] -
                    (a[h]._titleTextBlock ? a[h]._titleTextBlock.height : 0) -
                    ('inside' === a[h].tickPlacement ? a[h].tickLength : 0)),
                  (a[h].lineCoordinates.y2 =
                    a[h].lineCoordinates.y1 + a[h].lineThickness / 2)),
                (a[h].bounds = {
                  x1: p,
                  y1: g,
                  x2: l,
          ...
          if (d && 0 < d.length)
            for (h = 0; h < d.length; h++)
              (d[h].lineCoordinates.x1 = Math.round(f.x1 + O + L)),
                (d[h].lineCoordinates.x2 = Math.round(
                  f.x2 - $ - Z > m.width - n ? m.width - n : f.x2 - $ - Z
                )),
                (d[h].lineCoordinates.width = Math.abs(l - p)),
                d[h]._labels &&
                  ...
                  ((k = d[h]._labels[1]),
                  (g =
                    'dateTime' === d[h].valueType
                      ? d[h]._labels[d[h]._labels.length - 2]
                      : d[h]._labels[d[h]._labels.length - 1]),
                  (v =
                    k.textBlock.width *
                      Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) +
                    (k.textBlock.height - g.textBlock.fontSize / 2) *
                ...
                'inside' === d[h].labelPlacement &&
                  0 < h &&
                  (d[h].lineCoordinates.y1 =
                    d[h - 1].bounds.y1 -
                    A[h] +
                    (d[h]._titleTextBlock ? d[h]._titleTextBlock.height : 0)),
                (d[h].bounds = {
                  x1: p,
                  y1: g + (V + W - A[h] - S),
                  x2: l,
            ...
            for (h = 0; h < b.length; h++)
              (L = m.isNavigator ? 0 : 10),
                b[h] &&
                  ...
                  (L =
                    b[h]._labels && 0 < b[h]._labels.length
                      ? b[h]._labels[b[h]._labels.length - 1].textBlock.height /
                        2
                      : n),
                  (g = Math.round(
                    f.y1 + V + W < Math.max(L, n)
                      ? Math.max(L, n)
                      : f.y1 + V + W
                  )),
                  (l = Math.round(
                  ...
                  (L =
                    0 < a.length
                      ? 0
                      : b[h]._labels && 0 < b[h]._labels.length
                      ? b[h]._labels[0].textBlock.height / 2
                      : n),
                  ...
                  'inside' === b[h].labelPlacement &&
                    0 < h &&
                    ((b[h].lineCoordinates.x1 =
                      b[h].lineCoordinates.x1 -
                      (y[h] -
                        (b[h]._titleTextBlock
                          ? b[h]._titleTextBlock.height
                          : 0)) +
                      ('outside' === b[h].tickPlacement ? b[h].tickLength : 0)),
                    (b[h].lineCoordinates.x2 =
                      b[h].lineCoordinates.x1 + b[h].lineThickness / 2)),
                  (b[h].bounds = {
                    x1: p - (y[h] + U),
                    y1: g,
                    x2: l,
                  ...
                  b[h].title &&
                    (b[h]._titleTextBlock.maxWidth =
                      0 < b[h].titleMaxWidth &&
                      b[h].titleMaxWidth < b[h].lineCoordinates.height
                        ? b[h].titleMaxWidth
                        : b[h].lineCoordinates.height),
                  (U += y[h] + b[h].margin));
          if (c && 0 < c.length)
            for (h = 0; h < c.length; h++)
              c[h] &&
                ...
                (l = Math.round(p)),
                (L =
                  c[h]._labels && 0 < c[h]._labels.length
                    ? c[h]._labels[c[h]._labels.length - 1].textBlock.height / 2
                    : 0),
                (g = Math.round(
                  f.y1 + V + W < Math.max(L, n) ? Math.max(L, n) : f.y1 + V + W
                )),
                (L =
                  0 < a.length
                    ? 0
                    : c[h]._labels && 0 < c[h]._labels.length
                    ? c[h]._labels[0].textBlock.height / 2
                    : 0),
                (k = Math.round(f.y2 - (T + e + L))),
                (c[h].lineCoordinates = {
                  x1: p + X,
                ...
                'inside' === c[h].labelPlacement &&
                  0 < h &&
                  ((c[h].lineCoordinates.x1 =
                    c[h].lineCoordinates.x1 +
                    (D[h] -
                      (c[h]._titleTextBlock
                        ? c[h]._titleTextBlock.height
                        : 0)) -
                    ('outside' === c[h].tickPlacement ? c[h].tickLength : 0) -
                    2),
                  (c[h].lineCoordinates.x2 =
                    c[h].lineCoordinates.x1 + c[h].lineThickness / 2)),
                (c[h].bounds = {
                  x1: p,
                  y1: g,
                  x2: l + (D[h] + X),
                ...
                c[h].title &&
                  (c[h]._titleTextBlock.maxWidth =
                    0 < c[h].titleMaxWidth &&
                    c[h].titleMaxWidth < c[h].lineCoordinates.height
                      ? c[h].titleMaxWidth
              ...
              a[h] &&
                ...
                a[h]._labels &&
                  ...
                  ((z =
                    (a[h].logarithmic
                      ? Math.log(
                          a[h]._labels[1].position / a[h].viewportMinimum
                        ) / a[h].conversionParameters.lnLogarithmBase
                      : a[h]._labels[1].position - a[h].viewportMinimum) *
                  ...
                  (E = a[h].logarithmic
                    ...
                    : (0 < p
                        ? p * Math.abs(a[h].conversionParameters.pixelPerUnit)
                        : 0) + a[h].lineCoordinates.x1)));
          if (d && 0 < d.length)
            for (h = 0; h < d.length; h++)
              d[h].calculateValueToPixelConversionParameters(),
                ...
                d[h]._labels &&
                  ...
                  ((z =
                    (d[h].logarithmic
                      ? Math.log(
                          d[h]._labels[1].position / d[h].viewportMinimum
                        ) / d[h].conversionParameters.lnLogarithmBase
                      : d[h]._labels[1].position - d[h].viewportMinimum) *
                  ...
                  (E = d[h].logarithmic
                    ? (1 < p
                        ? (Math.log(p) /
                            d[h].conversionParameters.lnLogarithmBase) *
                          Math.abs(d[h].conversionParameters.pixelPerUnit)
                        : 0) + d[h].lineCoordinates.x1
                    : (0 < p
                        ? p * Math.abs(d[h].conversionParameters.pixelPerUnit)
                        : 0) + d[h].lineCoordinates.x1));
          for (h = 0; h < q.length; h++)
            'axisY' === q[h].type &&
              (q[h].calculateValueToPixelConversionParameters(),
              q[h].calculateBreaksSizeInValues());
          if (0 < w) {
            if (a && 0 < a.length)
              for (h = 0; h < a.length; h++)
                r = M[w - 1][h] === M[w][h] ? !0 : !1;
        ...
        for (N = []; 4 > w; ) {
          ...
          if (a && 0 < a.length)
            for (F = [], h = X = 0; h < a.length; h++)
              F.push(
                Math.ceil(a[h] ? a[h].createLabelsAndCalculateWidth() : 0)
              ),
                (X += F[h]),
                (e += a[h] && !m.isNavigator ? a[h].margin : 0);
          else
          ...
          M.push(F);
          if (d && 0 < d.length)
            for (v = [], h = T = 0; h < d.length; h++)
              v.push(
                Math.ceil(d[h] ? d[h].createLabelsAndCalculateWidth() : 0)
              ),
                (T += v[h]),
                (W += d[h] ? d[h].margin : 0);
          else
            ...
            for (h = 0; h < b.length; h++)
              (b[h].lineCoordinates = {}),
                ...
                b[h].title &&
                  (b[h]._titleTextBlock.maxWidth =
                    0 < b[h].titleMaxWidth &&
                    b[h].titleMaxWidth < b[h].lineCoordinates.width
                      ? b[h].titleMaxWidth
            ...
            for (h = 0; h < c.length; h++)
              (c[h].lineCoordinates = {}),
                ...
                c[h].title &&
                  (c[h]._titleTextBlock.maxWidth =
                    0 < c[h].titleMaxWidth &&
                    c[h].titleMaxWidth < c[h].lineCoordinates.width
                      ? c[h].titleMaxWidth
                      : c[h].lineCoordinates.width);
          if (b && 0 < b.length)
            for (n = [], h = U = 0; h < b.length; h++)
              n.push(
                Math.ceil(b[h] ? b[h].createLabelsAndCalculateHeight() : 0)
              ),
                (U += n[h] + b[h].margin),
                (L += b[h].margin);
          else
            n.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
          E.push(n);
          if (c && 0 < c.length)
            for (z = [], h = S = 0; h < c.length; h++)
              z.push(
                Math.ceil(c[h] ? c[h].createLabelsAndCalculateHeight() : 0)
              ),
                (S += z[h]),
                (Z += c[h].margin);
          else
            z.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          u.push(z);
          if (b && 0 < b.length)
            for (h = 0; h < b.length; h++)
          ...
          if (m.panEnabled)
            for (h = 0; h < b.length; h++)
              n[h] = s(m.sessionVariables.axisY.height)
                ? (m.sessionVariables.axisY.height = n[h])
          ...
          if (b && 0 < b.length)
            for (h = b.length - 1; 0 <= h; h--)
              (g = Math.round(f.y2)),
                (k = Math.round(
                  f.y2 > b[h].chart.height ? b[h].chart.height : f.y2
                )),
                (b[h].lineCoordinates.y1 = g - (n[h] + b[h].margin + V)),
                (b[h].lineCoordinates.y2 = g - (n[h] + b[h].margin + V)),
                'inside' === b[h].labelPlacement &&
                  0 < h &&
                  ((b[h].lineCoordinates.y1 =
                    b[h].lineCoordinates.y1 +
                    n[h] -
                    (b[h]._titleTextBlock ? b[h]._titleTextBlock.height : 0) -
                    ('inside' === b[h].tickPlacement ? b[h].tickLength : 0)),
                  (b[h].lineCoordinates.y2 =
                    b[h].lineCoordinates.y1 + b[h].lineThickness / 2)),
                (b[h].bounds = {
                  x1: p,
                  y1: g - (n[h] + V + b[h].margin),
                  x2: l,
                  y2: k - (V + b[h].margin),
                  width: l - p,
                  height: n[h],
          ...
          if (c && 0 < c.length)
            for (h = c.length - 1; 0 <= h; h--)
              c[h] &&
                ...
                'inside' === c[h].labelPlacement &&
                  0 < h &&
                  (c[h].lineCoordinates.y1 =
                    k -
                    z[h] +
                    (c[h]._titleTextBlock ? c[h]._titleTextBlock.height : 0)),
                (c[h].bounds = {
                  x1: p,
                  y1: g + (c[h].margin + G),
                  x2: l,
          ...
          if (a && 0 < a.length)
            for (h = 0; h < a.length; h++) {
              L =
                a[h]._labels && 0 < a[h]._labels.length
                  ? a[h]._labels[0].textBlock.fontSize / 2
                  : 0;
              p = Math.round(f.x1 + e);
              g =
                c && 0 < c.length
                  ...
                  b[L] &&
                    ...
                    ((l =
                      0 > b[L].labelAngle
                        ...
                        : l),
                    (p =
                      0 > b[L].labelAngle || 0 === b[L].labelAngle
                        ? l - X
                        : p));
              if (c && 0 < c.length)
                for (L = 0; L < c.length; L++)
                  c[L] &&
                    c[L].labelAutoFit &&
                    ((l = c[L].lineCoordinates.x1), (p = l - X));
              a[h].lineCoordinates = {
                x1: l - P,
                y1: g,
                x2: l - P,
              ...
              'inside' === a[h].labelPlacement &&
                ...
                ((a[h].lineCoordinates.x1 =
                  ...
                  (F[h] -
                    (a[h]._titleTextBlock ? a[h]._titleTextBlock.height : 0)) +
                  ('outside' === a[h].tickPlacement ? a[h].tickLength : 0)),
                (a[h].lineCoordinates.x2 =
                  a[h].lineCoordinates.x1 + a[h].lineThickness / 2));
              a[h].bounds = {
                x1: l - (F[h] + P),
                y1: g,
                x2: l,
              ...
              a[h].title &&
                (a[h]._titleTextBlock.maxWidth =
                  0 < a[h].titleMaxWidth &&
                  a[h].titleMaxWidth < a[h].lineCoordinates.height
                    ? a[h].titleMaxWidth
          ...
          if (d && 0 < d.length)
            for (h = 0; h < d.length; h++) {
              L =
                d[h]._labels && 0 < d[h]._labels.length
                  ? d[h]._labels[0].textBlock.fontSize / 2
                  : 0;
              p = Math.round(f.x1 - e);
              g =
                c && 0 < c.length
              ...
              if (c && 0 < c.length)
                for (L = 0; L < c.length; L++)
                  c[L] &&
                    c[L].labelAutoFit &&
                    ((l = c[L].lineCoordinates.x2), (p = l - T));
              d[h].lineCoordinates = {
                x1: l + R,
                y1: g,
                x2: l + R,
              ...
              'inside' === d[h].labelPlacement &&
                ...
                ((d[h].lineCoordinates.x1 =
                  ...
                  (v[h] -
                    (d[h]._titleTextBlock ? d[h]._titleTextBlock.height : 0) -
                    2) -
                  ('outside' === d[h].tickPlacement ? d[h].tickLength : 0)),
                (d[h].lineCoordinates.x2 =
                  d[h].lineCoordinates.x1 + d[h].lineThickness / 2));
              d[h].bounds = {
                x1: d[h].lineCoordinates.x1,
                y1: g,
                x2: l + v[h] + R,
                y2: k,
                width: l - p,
              ...
              d[h].title &&
                (d[h]._titleTextBlock.maxWidth =
                  0 < d[h].titleMaxWidth &&
                  d[h].titleMaxWidth < d[h].lineCoordinates.height
                    ? d[h].titleMaxWidth
                    : d[h].lineCoordinates.height);
              d[h].calculateValueToPixelConversionParameters();
              d[h].calculateBreaksSizeInValues();
              R += v[h] + d[h].margin;
            }
    ...
    E.render = function (a, d, b, c, e) {
      ...
      e.clip();
      if (a && 0 < a.length)
        for (var g = 0; g < a.length; g++) a[g].renderLabelsTicksAndTitle();
      if (d && 0 < d.length)
        for (g = 0; g < d.length; g++) d[g].renderLabelsTicksAndTitle();
      e.restore();
      if (b && 0 < b.length)
        for (g = 0; g < b.length; g++) b[g].renderLabelsTicksAndTitle();
      if (c && 0 < c.length)
        for (g = 0; g < c.length; g++) c[g].renderLabelsTicksAndTitle();
      f.preparePlotArea();
      f = f.plotArea;
      e.save();
      e.beginPath();
      ...
      if (a && 0 < a.length)
        for (g = 0; g < a.length; g++)
          a[g].renderStripLinesOfThicknessType('value');
      if (d && 0 < d.length)
        for (g = 0; g < d.length; g++)
          d[g].renderStripLinesOfThicknessType('value');
      if (b && 0 < b.length)
        for (g = 0; g < b.length; g++)
          b[g].renderStripLinesOfThicknessType('value');
      if (c && 0 < c.length)
        for (g = 0; g < c.length; g++)
          c[g].renderStripLinesOfThicknessType('value');
      if (a && 0 < a.length)
        for (g = 0; g < a.length; g++) a[g].renderInterlacedColors();
      if (d && 0 < d.length)
        for (g = 0; g < d.length; g++) d[g].renderInterlacedColors();
      if (b && 0 < b.length)
        for (g = 0; g < b.length; g++) b[g].renderInterlacedColors();
      if (c && 0 < c.length)
        for (g = 0; g < c.length; g++) c[g].renderInterlacedColors();
      e.restore();
      if (a && 0 < a.length)
        for (g = 0; g < a.length; g++)
          a[g].renderGrid(),
            w && (a[g].createMask(), a[g].renderBreaksBackground());
      if (d && 0 < d.length)
        for (g = 0; g < d.length; g++)
          d[g].renderGrid(),
            w && (d[g].createMask(), d[g].renderBreaksBackground());
      if (b && 0 < b.length)
        for (g = 0; g < b.length; g++)
          b[g].renderGrid(),
            w && (b[g].createMask(), b[g].renderBreaksBackground());
      if (c && 0 < c.length)
        for (g = 0; g < c.length; g++)
          c[g].renderGrid(),
            w && (c[g].createMask(), c[g].renderBreaksBackground());
      if (a && 0 < a.length)
        for (g = 0; g < a.length; g++) a[g].renderAxisLine();
      if (d && 0 < d.length)
        for (g = 0; g < d.length; g++) d[g].renderAxisLine();
      if (b && 0 < b.length)
        for (g = 0; g < b.length; g++) b[g].renderAxisLine();
      if (c && 0 < c.length)
        for (g = 0; g < c.length; g++) c[g].renderAxisLine();
      if (a && 0 < a.length)
        for (g = 0; g < a.length; g++)
          a[g].renderStripLinesOfThicknessType('pixel');
      if (d && 0 < d.length)
        for (g = 0; g < d.length; g++)
          d[g].renderStripLinesOfThicknessType('pixel');
      if (b && 0 < b.length)
        for (g = 0; g < b.length; g++)
          b[g].renderStripLinesOfThicknessType('pixel');
      if (c && 0 < c.length)
        for (g = 0; g < c.length; g++)
          c[g].renderStripLinesOfThicknessType('pixel');
    };
          ...
          if (
            ...
            for (
              var b = [],
                ...
                s = this.lineCoordinates.width / Math.log(this.range),
          ...
          if (
            ...
            for (
              var b = [],
                m,
                l = this.viewportMaximum,
                s = this.lineCoordinates.height / Math.log(this.range),
                k = this._labels.length - 1;
              0 <= k;
              k--
            ) {
        ...
        if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
          if (s(this.scaleBreaks.lastBreakIndex))
            ...
            for (
              ...
              d.moveTo(g, e),
                d.lineTo(g, this.scaleBreaks._appliedBreaks[l].startPixel + c),
        ...
        if ('axisX' === this.type) {
          ...
          'axisY' === this.type &&
            ...
            0 === e && 0 === f
              ? ((f += 9), (e = 0))
              : 0 === f - e
              ? ((c = Math.min(Math.abs(0.01 * Math.abs(f)), 5)),
                (f += c),
                (e -= c))
              : e > f
              ? ((c = Math.min(
    ...
    E.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      if (this.scaleBreaks)
        for (g = 0; g < this.scaleBreaks._appliedBreaks.length; g++)
          if (
            ((!s(this.sessionVariables.newViewportMinimum) &&
              this.sessionVariables.newViewportMinimum >=
                this.scaleBreaks._appliedBreaks[g].startValue) ||
              (!s(this.options.minimum) &&
                this.options.minimum >=
                  this.scaleBreaks._appliedBreaks[g].startValue) ||
              (!s(this.options.viewportMinimum) &&
      ...
      g = Math.pow(
        this.logarithmBase,
        E.getNiceNumber(Math.abs(Math.log(g) / d), !1)
      );
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = E.getNiceExponent(Math.log(g) / d / (a - 1), !0)),
          (b = E.getNiceNumber(l / (a - 1), !0)));
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
        this.viewportMinimum =
          'axisX' === this.type
            ? c / Math.sqrt(f)
          ...
          : 'axisY' === this.type &&
            ...
            isFinite(c) || isFinite(e)
              ? 1 === c && 1 === e
                ...
                : 1 === e / c
                ? ((g = Math.pow(this.logarithmBase, this.interval)),
                  (e *= g),
                  (c /= g))
                : c > e
                ? ((g = Math.min(0.01 * (c / e), 5)),
                  1 <= e ? (c = e / g) : (e = c * g))
                : ((g = Math.min(
                    (e / c) * Math.pow(this.logarithmBase, 0.01),
                    Math.pow(this.logarithmBase, 0.04)
          ...
          if (
            ...
            'left' === this.scaleBreaks.parent._position
              ? ((c = this.chart.plotArea.x1),
                (g = (this.chart.plotArea.x2 + n / 2 + 0.5) << 0))
              : ((c = this.chart.plotArea.x2),
                (g = (this.chart.plotArea.x1 - n / 2 + 0.5) << 0),
                (a *= -1)),
      ...
      if (0 < d) {
        ...
        if (
          ...
          (e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            ...
            (this.bounds = { x1: e - d / 2, y1: g, x2: f + d / 2, y2: l });
        else if (
          'left' === this.parent._position ||
          'right' === this.parent._position
        )
          (g = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            (e = this.chart.plotArea.x1),
            (f = this.chart.plotArea.x2),
            (this.bounds = { x1: e, y1: g - d / 2, x2: f, y2: l + d / 2 });
        this.ctx.moveTo(e, g);
        this.ctx.lineTo(f, l);
        this.ctx.stroke();
    ...
    $.prototype.showAt = function (a) {
      ...
      if ('xySwapped' === d.plotInfo.axisPlacement)
        if ('bottom' === this.parent._position)
          for (var c = 0; c < d.axisY.length; c++)
            this.parent === d.axisY[c] &&
              (d.axisY[c]._crosshairValue =
          ...
          for (c = 0; c < d.axisY2.length; c++)
            this.parent === d.axisY2[c] &&
              (d.axisY2[c]._crosshairValue =
          ...
          if ('right' === this.parent._position)
            for (c = 0; c < d.axisX2.length; c++)
              this.parent === d.axisX2[c] &&
                (d.axisX2[c]._crosshairValue =
        ...
        for (c = 0; c < d.axisX.length; c++)
          this.parent === d.axisX[c] &&
            (d.axisX[c]._crosshairValue =
              a >= d.axisX[c].viewportMinimum && a <= d.axisX[c].viewportMaximum
                ? a
                : null);
      else if ('top' === this.parent._position)
        for (c = 0; c < d.axisX2.length; c++)
        ...
        for (c = 0; c < d.axisY.length; c++)
          this.parent === d.axisY[c] &&
            (d.axisY[c]._crosshairValue =
              a >= d.axisY[c].viewportMinimum && a <= d.axisY[c].viewportMaximum
                ? a
                : null);
      ...
      for (c = 0; c < d.axisX.length; c++)
        (a = d.axisX[c]._crosshairValue),
          d.axisX[c].crosshair &&
            ...
            a >= d.axisX[c].viewportMinimum &&
            a <= d.axisX[c].viewportMaximum &&
            (d.axisX[c].showCrosshair(a),
            (d.axisX[c].crosshair._updatedValue = a),
            this === d.axisX[c].crosshair && (b = !0));
      for (c = 0; c < d.axisX2.length; c++)
        (a = d.axisX2[c]._crosshairValue),
          d.axisX2[c].crosshair &&
            ...
            a >= d.axisX2[c].viewportMinimum &&
            a <= d.axisX2[c].viewportMaximum &&
            (d.axisX2[c].showCrosshair(a),
            (d.axisX2[c].crosshair._updatedValue = a),
            this === d.axisX2[c].crosshair && (b = !0));
      for (c = 0; c < d.axisY.length; c++)
        (a = d.axisY[c]._crosshairValue),
          d.axisY[c].crosshair &&
            ...
            a >= d.axisY[c].viewportMinimum &&
            a <= d.axisY[c].viewportMaximum &&
            (d.axisY[c].showCrosshair(a),
            (d.axisY[c].crosshair._updatedValue = a),
            this === d.axisY[c].crosshair && (b = !0));
      for (c = 0; c < d.axisY2.length; c++)
        (a = d.axisY2[c]._crosshairValue),
          d.axisY2[c].crosshair &&
            ...
            a >= d.axisY2[c].viewportMinimum &&
            a <= d.axisY2[c].viewportMaximum &&
            (d.axisY2[c].showCrosshair(a),
            (d.axisY2[c].crosshair._updatedValue = a),
            this === d.axisY2[c].crosshair && (b = !0));
      this.chart.toolTip &&
    ...
    $.prototype.render = function (a, d, b) {
      ...
      if (this.snapToDataPoint) {
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
          ...
          if (
            ...
            if (
              ...
              l =
                1 === q.lineWidth % 2
                  ? (this.parent.convertValueToPixel(x.dataPoint.y[c]) << 0) +
                    0.5
                  : this.parent.convertValueToPixel(x.dataPoint.y[c]) << 0;
          ...
          if (
            ...
            w =
              1 === q.lineWidth % 2
                ? (this.parent.convertValueToPixel(x.dataPoint.y[c]) << 0) + 0.5
                : this.parent.convertValueToPixel(x.dataPoint.y[c]) << 0;
            k.text = this.labelFormatter
              ? this.labelFormatter({
                  chart: this.chart,
            ...
            'waterfall' === this.parent.dataSeries[y].type
              ? ((w =
                ...
                (k.text = this.labelFormatter
                  ...
                  : s(this.options.label)
                  ? ea(
                      b ? b : x.dataSeries.dataPointEOs[x.index].cumulativeSum,
                      this.valueFormatString,
                      this.chart._cultureInfo
                    )
                  : this.label),
        ...
        if (
          ...
          (c = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0),
            (f = this.chart.plotArea.y1),
            (g = this.chart.plotArea.y2),
            (this.bounds = { x1: c - n / 2, y1: f, x2: e + n / 2, y2: g });
        else if (
          ...
          (f = g = w = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0),
            (c = this.chart.plotArea.x1),
            (e = this.chart.plotArea.x2),
            (this.bounds = { x1: c, y1: f - n / 2, x2: e, y2: g + n / 2 });
        if ('xySwapped' === this.chart.plotInfo.axisPlacement)
            ...
            if (C) {
              ...
              'dateTime' === this.parent.valueType
                ? (k.text = this.labelFormatter
                    ...
                    : s(this.options.label)
                    ? Aa(
                        b ? b : this.parent.convertPixelToValue(d),
                        this.valueFormatString,
                        this.chart._cultureInfo
                      )
                    : this.label)
        ...
        'left' === this.parent._position && k.x < this.chart.bounds.x1
          ...
          : 'bottom' === this.parent._position &&
            ...
            (k.y = this.chart.bounds.y2 - k.height + k.fontSize / 2 + 2);
        0 < n &&
          (q.moveTo(c, f), q.lineTo(e, g), q.stroke(), (this._hidden = !1));
        q.restore();
        !s(k.text) &&
          ('number' === typeof k.text.valueOf() || 0 < k.text.length) &&
          k.render(!0);
          ...
          if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var v = 0; v < this.chart.axisX.length; v++) {
                for (
                  var g = this.chart.axisX[v].convertPixelToValue({ y: d }),
                    k = null,
                    c = 0;
                  c < this.chart.axisX[v].dataSeries.length;
                  c++
                )
                  (k = this.chart.axisX[v].dataSeries[c].getDataPointAtX(
                    g,
                    b
                  )) &&
                    0 <= k.index &&
                    ((k.dataSeries = this.chart.axisX[v].dataSeries[c]),
            ...
            if (this.chart.axisX2)
              for (v = 0; v < this.chart.axisX2.length; v++) {
                ...
                for (c = 0; c < this.chart.axisX2[v].dataSeries.length; c++)
                  (k = this.chart.axisX2[v].dataSeries[c].getDataPointAtX(
                    g,
                    b
                  )) &&
                    0 <= k.index &&
                    ((k.dataSeries = this.chart.axisX2[v].dataSeries[c]),
                    null !== k.dataPoint.y && l.push(k));
                k = null;
              }
          } else {
            ...
            if (this.chart.axisX)
              for (v = 0; v < this.chart.axisX.length; v++)
                for (
                  g = this.chart.axisX[v].convertPixelToValue({ x: a }),
                    k = null,
                    c = 0;
                  c < this.chart.axisX[v].dataSeries.length;
                  c++
            ...
            if (this.chart.axisX2)
              for (v = 0; v < this.chart.axisX2.length; v++)
                for (
                  g = this.chart.axisX2[v].convertPixelToValue({ x: a }),
                    k = null,
                    c = 0;
                  c < this.chart.axisX2[v].dataSeries.length;
                  c++
                )
                  (k = this.chart.axisX2[v].dataSeries[c].getDataPointAtX(
                    g,
          ...
          if ((this.highlightObjects(f), this.enabled)) {
            ...
            for (c = 0; c < f.length; c++)
              d.push({
                ...
                dataPoint: f[c].dataPoint,
                dataSeries: f[c].dataSeries,
                dataPointIndex: f[c].index,
                dataSeriesIndex: f[c].dataSeries._index,
              });
            d = {
              chart: this.chart,
    ...
    X.prototype.getToolTipInnerHTML = function (a) {
      a = a.entries;
      for (
        var d = null, b = null, c = null, e = 0, f = '', g = !0, l = 0;
        l < a.length;
        l++
      )
        ...
        for (var s = null, k = '', l = 0; l < a.length; l++)
          (b = a[l].dataSeries),
            ...
            null === c.toolTipContent ||
              ...
              null === d && (d = ''),
              !0 === this.reversed
                ? ((d = this.chart.replaceKeywordsWithValue(f, c, b, e) + d),
                  l < a.length - 1 && (d = '</br>' + d))
    ...
    X.prototype.showAtX = function (a, d) {
      ...
      if (this.shared)
        for (var g = 0; g < this.chart.data.length; g++)
          (b = this.chart.data[g]),
            (c = b.getDataPointAtX(a, !1)) &&
              c.dataPoint &&
              !s(c.dataPoint.y) &&
              b.visible &&
              ((c.dataSeries = b), f.push(c));
      else
        (b = this.chart.data[d]),
          (c = b.getDataPointAtX(a, !1)) &&
            c.dataPoint &&
      ...
      if (0 < f.length) {
        for (g = 0; g < f.length; g++)
          if (
            ((c = f[g]),
            c.dataPoint.x < c.dataSeries.axisX.viewportMinimum ||
              c.dataPoint.x > c.dataSeries.axisX.viewportMaximum ||
              c.dataPoint.y < c.dataSeries.axisY.viewportMinimum ||
              c.dataPoint.y > c.dataSeries.axisY.viewportMaximum)
          )
            e = !0;
          else {
            e = !1;
                  ...
                  ? (this.contentDiv.style.borderRightColor =
                      ...
                      this.contentDiv.style.borderColor =
                        this.options.borderColor
                          ...
                          ? f[0].dataSeries.color
                          : f[0].dataSeries._colorSet[
                              b.index % f[0].dataSeries._colorSet.length
                            ])
                  : (this.contentDiv.style.borderRightColor =
                      this.contentDiv.style.borderLeftColor =
                      this.contentDiv.style.borderColor =
    ...
    da.prototype.fireEvent = function (a, d, b) {
      if (a && d) {
        ...
        'mouseout' !== d
          ? f.cursor &&
            f.cursor !== b.target.style.cursor &&
            (b.target.style.cursor = f.cursor)
